...
public class BixeContentProvider extends ContentProvider {
    ...
    // database
    private StationDatabaseHelper database;
    ...
    public boolean onCreate() {
        database = new StationDatabaseHelper(getContext());
        return false;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        // Set the table
        queryBuilder.setTables(StationTable.TABLE_NAME);
        ...
        switch (uriType) {
            ...
            case TODO_ID:
                ...
                queryBuilder.appendWhere(StationTable.Columns.STATION_ID + "="
...
//        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case TODOS:
                rowsDeleted = sqlDB.delete(StationTable.TABLE_NAME, selection,
                        selectionArgs);
                break;
            case TODO_ID:
                String id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(StationTable.TABLE_NAME,
                            StationTable.Columns.STATION_ID + "=" + id,
                            null);
                } else {
                    rowsDeleted = sqlDB.delete(StationTable.TABLE_NAME,
                            StationTable.Columns.STATION_ID + "=" + id
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case TODOS:
                rowsUpdated = sqlDB.update(StationTable.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
                break;
    ...
    private void checkColumns(String[] projection) {
        String[] available = {StationTable.Columns.STATION_ID};
        if (projection != null) {
